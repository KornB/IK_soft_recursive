...
model_name = 'resultrealtime_log_ros_20251108_205609P'
norm_name  = 'resultrealtime_log_ros_20251108_205609P_norm.npz'
...
# TRAJECTORY
# =============================================================================
def generate_circle(radius=1.5, N=100):
...
df = pd.DataFrame(preds, columns=['P1','P2','P3'])
df.to_csv(os.path.join(save_dir, 'proximal_only.csv'), index=False)

print("Saved proximal_only.csv")
